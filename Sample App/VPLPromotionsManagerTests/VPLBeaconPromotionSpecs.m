...
describe(@"Initialization", ^{
    ...
    it(@"should set showOnce to true by default when setting repeatInterval to NSIntegerMax", ^{
        ...
        VPLBeaconPromotion *promotion = [[VPLBeaconPromotion alloc] initWithBeaconRegion:region
    ...
    it(@"should have the same identifier as the region's identifier", ^{
        ...
        expect(promotion.identifier).to.equal(promotion.beaconRegion.identifier);
    });
